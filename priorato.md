...
{% include image src='/images/escudo silos.webp' alt='' caption='Escudo de Silos' class='col-6 col-sm-4 col-md-3' %}
...
{% include image src='/images/priorato vista oeste.webp' alt='' class='float-right col-md-6' caption='El priorato visto desde el Oeste' %}
...
{% include image src='/images/priorato2.webp' alt='' caption='Fachada principal de la ermita' class='col-sm-4' %}
...
{% include image src='/images/retablo.webp' alt='' caption='Retablo mayor' class='col-md-6 float-right' %}
...
{% include image src='/images/arcos2.webp' alt='' caption='Arcos laterales' class='col-sm-4' %}
